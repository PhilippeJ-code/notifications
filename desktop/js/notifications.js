...
function saveEqLogic(_eqLogic) {
    ...
    _eqLogic.configuration.consigne_conf = document.querySelectorAll('#div_act_consigne .act_consigne').getJeeValues('.expressionAttr');
...
function printEqLogic(_eqLogic) {
    ...
    document.getElementById('div_act_consigne').innerHTML = '';

    if (isset(_eqLogic.configuration)) {
           if (isset(_eqLogic.configuration.consigne_conf)) {
            for (var i in _eqLogic.configuration.consigne_conf) {
                addAction(_eqLogic.configuration.consigne_conf[i], 'act_consigne');
            }
        }
    }
}
